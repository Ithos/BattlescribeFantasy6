...
<gameSystem id="fd97-5cfe-d46c-03c6" name="Warhammer_Fantasy-6ª Edición " revision="2" battleScribeVersion="2.03" authorName="Ithos" authorContact="" authorUrl="https://github.com/Ithos" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <categoryEntries>
    ...
    <categoryEntry id="6573-e7cf-6800-0acf" name="Héroe (no puede ser general)" hidden="false"/>
    <categoryEntry id="6180-e1cb-fb14-a986" name="Comandante (no puede ser general)" hidden="false"/>
  </categoryEntries>
  <forceEntries>
    <forceEntry id="19ec-029f-2b68-ae92" name="0-1999" hidden="false">
      <categoryLinks>
        ...
        <categoryLink id="5c7b-a731-5fad-1b8a" name="Héroe" hidden="false" targetId="c647-4209-4e6c-206a" primary="false">
          <modifiers>
            <modifier type="decrement" field="6e38-bd7f-fa4b-6d1a" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="6573-e7cf-6800-0acf" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
            <modifier type="decrement" field="6e38-bd7f-fa4b-6d1a" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="9769-7233-6405-675e" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
            <modifier type="decrement" field="6e38-bd7f-fa4b-6d1a" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="6180-e1cb-fb14-a986" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          </modifiers>
          <constraints>
            ...
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="95d2-67a4-a8f2-d859" type="min"/>
          </constraints>
        </categoryLink>
        ...
        <categoryLink id="16a6-e418-8a39-c143" name="Comandante (no puede ser general)" hidden="false" targetId="6180-e1cb-fb14-a986" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="0.0" percentValue="false" shared="false" includeChildSelections="true" includeChildForces="true" id="4b92-24bd-22c8-6d51" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="026e-42a1-ea50-dae0" name="Héroe (no puede ser general)" hidden="false" targetId="6573-e7cf-6800-0acf" primary="false">
          <modifiers>
            <modifier type="decrement" field="66b6-ef6e-4b40-4be4" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="c647-4209-4e6c-206a" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
            <modifier type="decrement" field="66b6-ef6e-4b40-4be4" value="1.0">
              <repeats>
          ...
          <constraints>
            <constraint field="selections" scope="parent" value="3.0" percentValue="false" shared="false" includeChildSelections="true" includeChildForces="true" id="66b6-ef6e-4b40-4be4" type="max"/>
          </constraints>
        </categoryLink>
      </categoryLinks>
    </forceEntry>
    <forceEntry id="c8d8-6feb-de16-2f2f" name="4000-4999" hidden="false">
      <categoryLinks>
        <categoryLink id="42fd-0388-d6ee-a269" name="Comandante" hidden="false" targetId="9769-7233-6405-675e" primary="false">
          <modifiers>
            <modifier type="set" field="3bc3-a7ec-693c-5cff" value="0.0">
              <conditions>
                <condition field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="c647-4209-4e6c-206a" type="greaterThan"/>
              </conditions>
            </modifier>
            <modifier type="decrement" field="1ba9-d6f8-19d8-2292" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="6180-e1cb-fb14-a986" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          ...
          <constraints>
            ...
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="3bc3-a7ec-693c-5cff" type="min"/>
          </constraints>
        </categoryLink>
        <categoryLink id="2730-810b-6c6e-97c0" name="Héroe" hidden="false" targetId="c647-4209-4e6c-206a" primary="false">
          <modifiers>
            <modifier type="set" field="b583-e135-76ed-005d" value="0.0">
              <conditions>
                <condition field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="9769-7233-6405-675e" type="greaterThan"/>
              </conditions>
            </modifier>
          ...
          <constraints>
            ...
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="b583-e135-76ed-005d" type="min"/>
          </constraints>
        </categoryLink>
        ...
        <categoryLink id="1cc4-976c-6b33-ed54" name="Comandante (no puede ser general)" hidden="false" targetId="6180-e1cb-fb14-a986" primary="false">
          <modifiers>
            <modifier type="decrement" field="8312-8120-effe-2666" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="9769-7233-6405-675e" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          ...
          <constraints>
            <constraint field="selections" scope="parent" value="3.0" percentValue="false" shared="false" includeChildSelections="true" includeChildForces="true" id="8312-8120-effe-2666" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="3143-137d-27a0-8a97" name="Héroe (no puede ser general)" hidden="false" targetId="6573-e7cf-6800-0acf" primary="false">
          <modifiers>
            <modifier type="decrement" field="8bf6-3252-d191-afe8" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="c647-4209-4e6c-206a" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          ...
          <constraints>
            <constraint field="selections" scope="parent" value="8.0" percentValue="false" shared="false" includeChildSelections="true" includeChildForces="true" id="8bf6-3252-d191-afe8" type="max"/>
          </constraints>
        </categoryLink>
      </categoryLinks>
    </forceEntry>
    <forceEntry id="332b-d853-aebf-0295" name="2000-2999" hidden="false">
      <categoryLinks>
        <categoryLink id="acb5-2500-8496-d528" name="Comandante" hidden="false" targetId="9769-7233-6405-675e" primary="false">
          <modifiers>
            <modifier type="set" field="abaa-ec5d-eec3-686a" value="0.0">
              <conditions>
                <condition field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="c647-4209-4e6c-206a" type="greaterThan"/>
              </conditions>
            </modifier>
            <modifier type="decrement" field="d4b4-2a0d-0459-e5a1" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="6180-e1cb-fb14-a986" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          ...
          <constraints>
            ...
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="abaa-ec5d-eec3-686a" type="min"/>
          </constraints>
        </categoryLink>
        <categoryLink id="51f7-bec6-a9fe-0ec5" name="Héroe" hidden="false" targetId="c647-4209-4e6c-206a" primary="false">
          <modifiers>
            <modifier type="set" field="0183-d456-1b07-b35f" value="0.0">
              <conditions>
                <condition field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="9769-7233-6405-675e" type="greaterThan"/>
              </conditions>
            </modifier>
            <modifier type="decrement" field="a49b-d3c2-4105-2e59" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="6573-e7cf-6800-0acf" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          ...
          <constraints>
            ...
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="0183-d456-1b07-b35f" type="min"/>
          </constraints>
        </categoryLink>
        ...
        <categoryLink id="75e2-1278-33d6-5d76" name="Comandante (no puede ser general)" hidden="false" targetId="6180-e1cb-fb14-a986" primary="false">
          <modifiers>
            <modifier type="decrement" field="39db-5089-d81e-3b91" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="9769-7233-6405-675e" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          ...
          <constraints>
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="false" includeChildSelections="true" includeChildForces="true" id="39db-5089-d81e-3b91" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="b674-ccc8-7e55-f937" name="Héroe (no puede ser general)" hidden="false" targetId="6573-e7cf-6800-0acf" primary="false">
          <modifiers>
            <modifier type="decrement" field="0d55-12ad-661e-ea13" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="c647-4209-4e6c-206a" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          ...
          <constraints>
            <constraint field="selections" scope="parent" value="4.0" percentValue="false" shared="false" includeChildSelections="true" includeChildForces="true" id="0d55-12ad-661e-ea13" type="max"/>
          </constraints>
        </categoryLink>
      </categoryLinks>
    </forceEntry>
    <forceEntry id="82a5-5766-86ca-d92f" name="3000-3999" hidden="false">
      <categoryLinks>
        <categoryLink id="075a-0626-e9ba-84c6" name="Comandante" hidden="false" targetId="9769-7233-6405-675e" primary="false">
          <modifiers>
            <modifier type="set" field="d1e9-b288-275f-48c5" value="0.0">
              <conditions>
                <condition field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="c647-4209-4e6c-206a" type="greaterThan"/>
              </conditions>
            </modifier>
            <modifier type="decrement" field
name="Comandante (no puede ser general)" hidden="false" targetId="6180-e1cb-fb14-a986" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="0.0" percentValue="false" shared="false" includeChildSelections="true" includeChildForces="true" id="c9ba-09e9-f8e6-c89a" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="a506-5770-60ee-8992" name="Héroe (no puede ser general)" hidden="false" targetId="6573-e7cf-6800-0acf" primary="false">
          <modifiers>
            <modifier type="decrement" field="96ea-fcfa-b19d-4624" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="c647-4209-4e6c-206a" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          ...
          <constraints>
            <constraint field="selections" scope="parent" value="3.0" percentValue="false" shared="false" includeChildSelections="true" includeChildForces="true" id="96ea-fcfa-b19d-4624" type="max"/>
          </constraints>
        </categoryLink>
      </categoryLinks>
    </forceEntry>
    <forceEntry id="7f9f-98d0-6bfe-deb8" name="Contingente aliado en ejército conjunto de 3000-3999" hidden="false">
      <infoLinks>
        <infoLink id="ef77-b83c-245a-0a20" name="Aliados" hidden="false" targetId="d058-5164-c40e-286f" type="rule"/>
      </infoLinks>
      <categoryLinks>
        ...
        <categoryLink id="cda1-28dd-8885-4ee8" name="Héroe" hidden="false" targetId="c647-4209-4e6c-206a" primary="false">
          <modifiers>
            <modifier type="set" field="f0b8-a7c5-45ef-55d8" value="0.0">
              <conditions>
                <condition field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="9769-7233-6405-675e" type="greaterThan"/>
              </conditions>
            </modifier>
            <modifier type="decrement" field="00f0-1627-232f-debf" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="6180-e1cb-fb14-a986" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
        ...
        <categoryLink id="e8ae-9ece-e2ea-e076" name="Comandante" hidden="false" targetId="9769-7233-6405-675e" primary="false">
          <modifiers>
            <modifier type="set" field="21dd-ab76-2ac3-2d20" value="0.0">
              <conditions>
                <condition field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="c647-4209-4e6c-206a" type="greaterThan"/>
              </conditions>
            </modifier>
            <modifier type="decrement" field="86e2-90c5-71c5-60f4" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="6180-e1cb-fb14-a986" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          ...
          <constraints>
            ...
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="21dd-ab76-2ac3-2d20" type="min"/>
          </constraints>
        </categoryLink>
        ...
        <categoryLink id="d53a-eac7-c349-c6c4" name="Comandante (no puede ser general)" hidden="false" targetId="6180-e1cb-fb14-a986" primary="false">
          <modifiers>
            <modifier type="decrement" field="24ae-9265-9b41-5b98" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="9769-7233-6405-675e" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          ...
          <constraints>
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="24ae-9265-9b41-5b98" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="cb57-35b2-6670-56d7" name="Héroe (no puede ser general)" hidden="false" targetId="6573-e7cf-6800-0acf" primary="false">
          <modifiers>
            <modifier type="decrement" field="8cdf-1ff4-c69f-ccad" value="1.0">
              <repeats>
                <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="c647-4209-4e6c-206a" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          ...
          <constraints>
            <constraint field="selections" scope="parent" value="4.0" percentValue="false" shared="false" includeChildSelections="true" includeChildForces="true" id="8cdf-1ff4-c69f-ccad" type="max"/>
          </constraints>
        </categoryLink>
      </categoryLinks>
    </forceEntry>
...
Actuarán como una unidad independiente el resto de la batalla. No es posible resucitar la Esfinge aunque la dotación (o personaje) sigan vivos.</description>
    ...
    <rule id="d058-5164-c40e-286f" name="Aliados" hidden="false">
      <description>Un contingente aliado solo puede añadirse a un ejercito principal clasificado como aliado. Los aliados pueden ser amistosos o no amistosos.
En caso de añadirse a una fuerza principal de aliados no amistosos, si hay unidades del ejercito principal que se encuentren a 15 cm o menos de una unidad de la fuerza aliada tanto las unidades de la fuerza principal como las aliadas aplican un penalizador de -1 al liderazgo.</description>
    </rule>
  </sharedRules>
  <sharedProfiles>
